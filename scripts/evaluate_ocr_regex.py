"""
evaluate_ocr_regex.py — Full evaluation of the OCR+Regex method against gold labels.

Mirrors the structure of evaluate_all.py / evaluate_hybrid.py so all 4 methods
share the same output format and can be compared in the plots.

Usage (from repo root):
    python scripts/evaluate_ocr_regex.py

Writes to:
    assets/dataset/evaluation_reports/ocr_regex_per_receipt.json
    assets/dataset/evaluation_reports/ocr_regex_summary.json
    assets/dataset/predictions/ocr_regex/<receipt_id>.json
"""
